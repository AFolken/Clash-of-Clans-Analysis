...
ui <- fillPage(
  ...
  # Main panel for displaying outputs ----
    ...
    plotlyOutput("plot", height = "90%"),padding = c(0,'2%')
    #width = 12,
    #height = "100%"
...
clash_defense <- read_excel("clash.xlsx",sheet = "Defense")
clash_heros <- read_excel("clash.xlsx",sheet = "Heros")
clash_buildings <- read_excel("clash.xlsx",sheet = "Buildings")
